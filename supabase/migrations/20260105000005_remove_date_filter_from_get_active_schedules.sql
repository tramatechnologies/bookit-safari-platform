-- Remove date filtering from get_active_schedules to show all active schedules
-- This allows filtering by date at the application level if needed

DROP FUNCTION IF EXISTS public.get_active_schedules(date, numeric, numeric, uuid, uuid);
